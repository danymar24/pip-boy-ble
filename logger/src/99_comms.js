...
Pip.processBuffer = function () {
  try {
    ...
    // If a weird string crashes the parser, we catch the error silently 
    // here so the rest of the Wand OS doesn't crash.
  } finally {
    // ==========================================
    // THE FIX: This block executes NO MATTER WHAT.
    // It guarantees the lock is always released!
    // ==========================================
    Pip.isProcessing = false;
  }
